...
SECRET_KEY = 'pyu(6ub^)cn&9i(nq#3vx57=wy18qn76a5%4p(&j%w8&c&%)li'
# 是否开启[在线工具]应用
...
EMAIL_HOST_USER = os.getenv('IZONE_EMAIL_HOST_USER', 'xie18861872581@163.com')
EMAIL_HOST_PASSWORD = os.getenv('IZONE_EMAIL_HOST_PASSWORD', 'FSSSWCFXQHMOPYWX')  # 这个不是邮箱密码，而是授权码
...
DEFAULT_FROM_EMAIL = os.getenv('IZONE_DEFAULT_FROM_EMAIL', 'Kang Life-record博客 <xie18861872581@163.com>')

# 网站默认设置和上下文信息
SITE_LOGO_NAME = os.getenv('IZONE_LOGO_NAME', 'Record-Myblog')
SITE_END_TITLE = os.getenv('IZONE_SITE_END_TITLE', 'Life-record')
SITE_DESCRIPTION = os.getenv('IZONE_SITE_DESCRIPTION', 'Life-record 是一个使用 Django+Bootstrap4+xadmin 搭建的个人博客类型网站')
SITE_KEYWORDS = os.getenv('IZONE_SITE_KEYWORDS', 'Life-record,Django博客,个人博客')
...
# 个性化设置，非必要信息
# 个人 Github 地址
MY_GITHUB = os.getenv('IZONE_GITHUB', 'https://github.com/xiexukang')
# 工信部备案信息
