...
class Article(models.Model):
    ...
    # #img_link = ProcessedImageField(upload_to='article_fengmian/%Y/%m/%d',
    #                              default=IMG_LINK,
    #                              verbose_name='图片地址',
...
class Timeline(models.Model):
    ...
    IMG_FONT = (
        ...
        ('fa fa-bell', '铃铛标签'),
        ('fa fa-diamond', '砖石标签'),
        ('fa fa-commenting-o', '评论标签'),
        ('fa fa-gavel', '工具标签'),
        ('fa fa-database', '数据库标签'),
        ('fa fa-music', '音乐标签'),
        ('fa fa-film', '音乐标签'),
    ...
    icon = models.CharField('图标', max_length=50, choices=IMG_FONT, default='fa fa-pencil')
